$(function () {
    $('#layout-header').load("https://portfolio.jttorate.com/layout/header.html", function () {
        ...
        if (index || urlLastQuery === "") {
            ...
            $("#layout-header header nav ul").find(".nav-skills").addClass("active");
        } else if (services) {
            $("#layout-header header nav ul").find(".nav-services").addClass("active");
        } else if (experience) {
            $("#layout-header header nav ul").find(".nav-experience").addClass("active");
        } else if (references) {
            $("#layout-header header nav ul").find(".nav-references").addClass("active");
